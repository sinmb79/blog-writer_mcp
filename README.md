...
- Google Blogger 블로그 또는 WordPress 사이트 / Google Blogger blog or WordPress site
...
6. 발행 (`blog_publish`, `platform="blogger" | "wordpress" | "both"`)
...
| `blog_publish` | Blogger / WordPress 발행 / Publish to Blogger or WordPress | `publisher_bot.py` + `wp_publisher_bot.py` |
